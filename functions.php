<?php
	...
	function dashboard_pilot_news_widget_function() {
		...
		echo '<p>Stuur een mailtje naar de <a href="mailto:webshop@oft.be">Helpdesk E-Commerce</a> als er toch nog iets onduidelijk is, of als je een suggestie hebt.</p>';
		echo '</div>';
	}
